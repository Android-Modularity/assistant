package com.zfy.assistant.module.tools;
...
import com.zfy.assistant.IAssistant;
...
import com.zfy.assistant.utils.SignUtils;
...
public class ToolsFragment extends BaseAssistFragment {
    ...
    private void initDatas() {
        ...
        mToolsModels.add(new ToolsModel("上次扫描", assist.info().scanResult, () -> {
            String result = Assistant.assist().info().scanResult;
        ...
        mToolsModels.add(new ToolsModel("Build.BRAND", Build.BRAND));
        mToolsModels.add(new ToolsModel("Channel", Common.appConfig().CHANNEL));
        mToolsModels.add(new ToolsModel("Build.MODEL", Build.MODEL));
        mToolsModels.add(new ToolsModel("Build.VERSION", Build.VERSION.RELEASE));
